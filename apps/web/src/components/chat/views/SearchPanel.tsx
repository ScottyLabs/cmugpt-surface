import { CloseIcon, FrownIcon, PlusIcon, SearchIcon } from "@/components/icons/index.tsx";
...
export function SearchPanel({ c }: { c: ChatShellController }) {
  ...
  const { searchQ, setSearchQ, searchInputRef, searchChats, searchChatsLoading } = search;
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
        {searchQ.trim() ? (
          searchChatsLoading ? (
            <div className="p-6 text-center text-sm text-fg-neutral-tertiary">Searching…</div>
            ...
            <div className="px-10 pb-6 pt-8">
              ...
              <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-4">
                {searchChats.map((chat) => (
                  ...
                  >
                    <p className="w-full break-words text-lg font-medium text-black">
                      {chat.title}
                    </p>
                    {chat.updatedAt ? (
